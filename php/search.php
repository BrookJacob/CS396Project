...
<?php
    ...
    $likeSearch = '%'.$search.'%';
	$sql = "SELECT b.ISBN10, b.ISBN13, b.title, b.author, g.genreName FROM books AS b, genres as g WHERE b.genreID = g.genreID AND b.title LIKE ? OR b.author LIKE ? OR b.ISBN13 = ? OR b.ISBN10 = ? OR g.genreName LIKE ?";
