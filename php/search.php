...
<?php
    ...
    $likeSearch = '%'.$search.'%';
	$sql = "SELECT b.ISBN10, b.ISBN13, b.title, b.author, b.genreID, g.genreName, g.genreID FROM books AS b, genres as g FULL OUTER JOIN genres ON b.genreID = g.genreID WHERE b.title LIKE ? OR b.author LIKE ? OR b.ISBN13 = ? OR b.ISBN10 = ? OR g.genreName LIKE ?";
